/*
const tituloIndex = document.getElementById ("localS")
localStorage.setItem ('mensaje', 'mensajito de localS' )
let mensaje = localStorage.getItem ('mensaje')
tituloIndex.innerText = mensaje

//ARRAY CON METODO PUSH PARA AGREGAR UN JUEGO EN EL CATALOGO
//const catalogoDePro ductos = ["Tren de mandera rojo", "Tren de mandera verde", "Tren de mandera azul", "Rompecabezas de 5 piezas", "Rompecabezas de 10 piezas", "Rompecabezas de 25 piezas", "Disfraces", "Libros infantiles"]
